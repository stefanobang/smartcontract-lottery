...
!developmentChains.includes(network.name)
    ...
    : describe("Lottery Unit Tests", function () {
          ...
          describe("constructor", async function () {
              it("Initializes the lottery corretly", async function () {
          ...
          describe("enterLottery", function () {
              ...
              it("doesn't allow entrance when lottery is calculating", async function () {
                  ...
                  ).to.be.revertedWithCustomError(lottery, "LotteryNOTOPEN")
              })
          })

          // describe("enterLottery", async function () {
          //     it("It will revert/refund when you do not pay enough", async function () {
          //         await expect(lottery.enterLottery()).to.be.revertedWith(
          //             "Er_NotEnoughETH_ENTERED"
          //         )
          //     })
          //     it("records the customer when they enter", async function () {
          //         await lottery.enterLottery({ value: lotteryEntranceFee })
          //         const customerFromContract = await lottery.getCustomer(0)
          //         assert.equal(customerFromContract, deployer)
          //     })
          ...
          //             interval.toNumber() + 1,
          //         ])
          //         await network.provider.send.apply("evm_mine", [])
